...
const SKILL_CATEGORIES = {
  ...
  "Frontend": ["Html", "BootStrap Css", "React", "Redux"],
  "Backend": ["Node.js", "Express.js"],
  "DevOps & Tools": ["Git", "Docker", "GitHub", "Jenkins"],
  "CS Fundamentals": ["Data Structures and Algorithms", "OOP", "DBMS", "Operating Systems"]
};
...
const SkillsSection: React.FC<SkillsProps> = ({ skills }) => {
  ...
  const categories = [
    ...
    { id: "CS Fundamentals", label: "CS Fundamentals", icon: <Brain className="w-5 h-5" /> },
