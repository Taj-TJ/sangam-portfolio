...
export const RESUME_DATA = {
  ...
  contact: {
    email: "sanjubishnoi076@gmail.com",
    tel: "7015831756",
    social: [
      {
        name: "GitHub",
        url: "https://github.com/sangamkhoth",
        icon: GitHubIcon,
      },
      {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/sangambishnoi/",
        icon: LinkedInIcon,
      },
      {
        name: "Instagram",
        url: "https://www.instagram.com/sngmbishnoi/",
        icon: InstagramIcon,
      },
    ],
  },
  education: [
    ...
    {
      school: "Surya School Sadalpur",
      degree: "Matriculation",
      start: "2018",
      end: "2020",
    },
    {
      school: "V.M Vishvas School",
