                    ...
                    {index === 0 && (
                      <div className="mt-4 bg-primary/10 dark:bg-primary/20 p-3 rounded-lg">
                        <div className="flex items-start gap-2">
                          ...
                          Part of the prestigious Lovely Professional University (LPU), known for its world-class infrastructure, industry-aligned curriculum, and NAAC A++ accreditation.
                          </p>
                        </div>
                      </div>
                    )}
                    {index === 1 && (
                      <div className="mt-4 bg-primary/10 dark:bg-primary/20 p-3 rounded-lg">
                        <div className="flex items-start gap-2">
                          <BookOpenIcon className="w-5 h-5 text-primary dark:text-primary-light mt-1" />
                          <p className="text-sm text-gray-700 dark:text-gray-300">
                          Completed Secondary Education with a focusing on core concepts.
                          </p>
                        </div>
                      </div>
                    )}
